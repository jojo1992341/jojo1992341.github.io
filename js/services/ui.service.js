...
window.UIService = class UIService {
    ...
    renderProgramTable(currentWeek, feedbackHandlers = null) {
        ...
        this.ui.display.tableBody.innerHTML = currentWeek.program.map(day => {
            ...
            const trainingRow = `<tr data-day-type="${day.dayType}" data-time-of-day="${day.timeOfDay || ''}" ${isTestDay ? '' : `class="session-row" data-session-day="${day.day}"`}>
            ...
            return `${trainingRow}
            <tr class="feedback-inline-row hidden" data-feedback-row="${day.day}" data-day-type="${day.dayType}" data-time-of-day="${day.timeOfDay || ''}">
